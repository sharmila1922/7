...
class AddLocationScreen(Screen):
    ...
    def __init__(self, **kwargs):
        ...
        Clock.schedule_once(self.request_permissions, 0)  # Delay the permission request
    ...
    def request_permissions(self, android=None, *args):
        if platform == 'android':
            ...
            # Use the Android API to request storage permission
    ...
    def on_request_permissions(self, permissions, results):
        if all(result for result in results):
            ...
            toast("File manager permission denied. Some features may not work.")
